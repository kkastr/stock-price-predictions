...
parser.add_argument('--update', dest='update', action='store_true', default=False,
                    help='Update data file')
parser.add_argument('-ticker', dest='ticker', type=str,
                    help='The ticker for the security (i.e. GOOG, AMZN, etc).')
parser.add_argument('-from', dest='start_date', type=datetime.date.fromisoformat,
                    help='The first date in the period of interest.')
parser.add_argument('-to', dest='end_date', type=datetime.date.fromisoformat,
